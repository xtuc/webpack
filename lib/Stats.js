...
class Stats {
	 ...
	 * @return {string[]} returns the filtered warnings
	 */
	 ...
	 * @return {string} returns the normalized file path
	 */
	...
	/**
	 * @return {boolean} returns true if the compilation contains warnings
	 */
	hasWarnings() {
		return (
	...
	/**
	 * @return {boolean} returns true if the compilation contains errors
	 */
	hasErrors() {
		return (
	...
	// TODO: Remove from this class and convert to a function in webpack 5
	/**
	 * @description Remove a prefixed "!" that can be specified to reverse sort order.
	 * @param {string} field the field name
	 * @return {string} returns normalized name
	 */
	...
	// TODO: Remove from this class and convert to a function in webpack 5
	/**
	 * @description If a field is prefixed by a "!" reverse sort order.
	 * @param {string} field the field name
	 * @return {boolean} returns true if the sort order is regular, false if the order is reversed.
	 */
