...
class WebpackOptionsDefaulter extends OptionsDefaulter {
	constructor() {
		...
		this.set("optimization.removeEmptyChunks", "make", options =>
			isProductionLikeMode(options)
		);
		this.set("optimization.mergeDuplicateChunks", "make", options =>
			isProductionLikeMode(options)
		);
		...
		this.set("optimization.splitChunks.minSize", "make", options => {
			return isProductionLikeMode(options) ? 30000 : 0;
		});
